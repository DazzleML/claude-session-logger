...
scripts-repo/generate_channel_docs.py. Between 2026-05 (Phase 0b moved
...
Fix when red:  python scripts-repo/generate_channel_docs.py
"""
import importlib.util
from pathlib import Path

REPO = Path(__file__).resolve().parents[2]
GENERATOR = REPO / "scripts-repo" / "generate_channel_docs.py"
...
def test_channels_md_matches_generator_output():
    ...
    assert actual == expected, (
        ...
        "documents. Regenerate it:  python scripts-repo/generate_channel_docs.py"
    )
